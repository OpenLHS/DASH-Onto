 ...
 * [DASH-Onto.yml](DASH-Onto.yml)
     * Determines how your purl.obolibrary.org/obo/DASH-Onto/ redirects will be handled
     ...
     * Paste in the contents of [DASH-Onto.yml](DASH-Onto.yml)
 ...
 * [DASH-Onto.md](DASH-Onto.md)
     ...
     * Paste in the contents of [DASH-Onto.md](DASH-Onto.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
